...
#+BEGIN_SRC emacs-lisp
    ...
    ;; Adding custom versions of CEDET and Org-Mode These will require you to pull submodules
    ;; and make each of these. I've also included a tar file with the latest working version
    ;; if git is broken in some way for you.
    ;; TODO: Automate this in the future
    (when (file-exists-p "~/.emacs.d/elisp/cedet/cedet-devel-load.el")
      (load "~/.emacs.d/elisp/cedet/cedet-devel-load.el"))

 ;;   (when (file-exists-p "~/.emacs.d/elisp/org-mode/lisp")
