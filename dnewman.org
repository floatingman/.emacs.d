...
(defadvice require
  (around sanityinc/build-require-times (feature &optional filename noerror) activate)
...
(when (maybe-require-package 'magit)
  (setq-default
   ...
   magit-diff-refine-hunt t
   magit-completing-read-function 'magit-ido-completing-read)
   
   ;; Hint: customize `magit-repo-dirs' so that you can use C-u M-F12 to
   ;; quickly open magt on any one of your projects.
...
#+end_src
*** Auto-complete
Switching back to company mode
#+begin_src emacs-lisp :tangle no
...
(dolist (mode '(log-edit-mode org-mode text-mode haml-mode
                ...
                html-mode web-mode nxml-mode sh-mode smarty-mode clojure-mode
...
(push 'ac-html-angular company-backends)
(push 'ac-ispell company-backends)
(push 'ac-php company-backends)
...
(add-hook 'projectile-modede-hook 'projectile-rails-on)
#+end_src
...
(yas-global-mode 1)
;(define-key yas-minor-mode-map (kbd "\t") 'hippie-expand)
